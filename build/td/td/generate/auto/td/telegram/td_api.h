...
class attachmentMenuBot final : public Object {
 public:
  ...
  attachmentMenuBot(int53 bot_user_id_, string const &name_, object_ptr<attachmentMenuBotColor> &&name_color_, object_ptr<file> &&default_icon_, object_ptr<file> &&ios_static_icon_, object_ptr<file> &&ios_animated_icon_, object_ptr<file> &&android_icon_, object_ptr<file> &&macos_icon_, object_ptr<attachmentMenuBotColor> &&icon_color_);

  static const std::int32_t ID = 1585626672;
  std::int32_t get_id() const final {
    return ID;
  }
...
class botInfo final : public Object {
 public:
  ...
  botInfo(string const &share_text_, string const &description_, object_ptr<botMenuButton> &&menu_button_, array<object_ptr<botCommand>> &&commands_, object_ptr<chatAdministratorRights> &&default_group_administrator_rights_, object_ptr<chatAdministratorRights> &&default_channel_administrator_rights_);

  static const std::int32_t ID = 1262833787;
  std::int32_t get_id() const final {
    return ID;
  }
...
class internalLinkTypeAttachmentMenuBot final : public InternalLinkType {
 public:
  object_ptr<InternalLinkType> chat_link_;
  string bot_username_;
  string url_;

  internalLinkTypeAttachmentMenuBot();

  internalLinkTypeAttachmentMenuBot(object_ptr<InternalLinkType> &&chat_link_, string const &bot_username_, string const &url_);

  static const std::int32_t ID = 1670586452;
  std::int32_t get_id() const final {
    return ID;
  }
...
class themeParameters final : public Object {
 public:
  ...
  themeParameters(int32 background_color_, int32 text_color_, int32 hint_color_, int32 link_color_, int32 button_color_, int32 button_text_color_);

  static const std::int32_t ID = -1922104364;
  std::int32_t get_id() const final {
    return ID;
  }
...
class userFullInfo final : public Object {
 public:
  ...
  userFullInfo(object_ptr<chatPhoto> &&photo_, bool is_blocked_, bool can_be_called_, bool supports_video_calls_, bool has_private_calls_, bool has_private_forwards_, bool need_phone_number_privacy_exception_, string const &bio_, int32 group_in_common_count_, object_ptr<botInfo> &&bot_info_);

  static const std::int32_t ID = -1308032111;
  std::int32_t get_id() const final {
    return ID;
  }
...
class getPaymentForm final : public Function {
 public:
  ...
  getPaymentForm(int53 chat_id_, int53 message_id_, object_ptr<themeParameters> &&theme_);

  static const std::int32_t ID = -1874784169;
  std::int32_t get_id() const final {
    return ID;
  }
